      ...
      <div className="py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="relative max-w-3xl mx-auto text-center pb-12">
            <Image className="absolute right-full top-0 -translate-x-full -mt-3 pointer-events-none mix-blend-exclusion" src={FeaturesIllustration} width={116} height={116} alt="Features illustration" aria-hidden="true" />
