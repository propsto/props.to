...
export function StepComponent({
  ...
  // For organization users, username is locked to email prefix
  const emailUsername = email
    ? email
        ...
        .replace(/[^a-z0-9_-]/g, "")
    : null;
  const isUsernameLocked = Boolean(hostedDomain && emailUsername);
    ...
    <div className="space-y-6 text-start">
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          value={isUsernameLocked ? (emailUsername ?? "") : undefined}
        />
        {errors.username ? (
        ...
        <p className="text-xs text-muted-foreground">
          {isUsernameLocked ? (
            <>
              Your username is based on your Google Workspace email:{" "}
              <b>
                props.to/{hostedDomain?.split(".")[0]}/{emailUsername}
              </b>
            </>
          ) : (
            <>
